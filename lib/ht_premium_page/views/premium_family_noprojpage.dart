...
class HTClassFamilyNoProjPage extends StatefulWidget {
  const HTClassFamilyNoProjPage({Key? key, required this.title})
      : super(key: key);
  ...
  @override
  State<HTClassFamilyNoProjPage> createState() =>
      _HTClassFamilyNoProjPageState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Column(children: [
          Container(
              margin: EdgeInsets.fromLTRB(63.0, 49.0, 62.0, 0),
              child: Text("You Have Not Purchased Or Joined Any \nFamily Plan",
                  style: TextStyle(color: Color(0xff999999), fontSize: 13.0))),
          GestureDetector(
              child: Container(
                margin: EdgeInsets.fromLTRB(38.0, 50.0, 37.0, 0.0),
                height: 44.0,
          ...
          GestureDetector(
              child: Container(
                  child: Text("Or wait for invitation",
                      style:
                          TextStyle(color: Color(0xff999999), fontSize: 13.0))),
              onTap: () {
