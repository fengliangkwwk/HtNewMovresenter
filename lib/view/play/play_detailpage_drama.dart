...
class HTClassDramaDetailPage extends StatefulWidget {
  const HTClassDramaDetailPage({Key? key, required this.title}) : super(key: key);
...
class _HTClassDramaDetailPageState extends State<HTClassDramaDetailPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: SingleChildScrollView(controller:_htVarScrollController,child:Column(crossAxisAlignment:CrossAxisAlignment.start,children: [
            Container(height:220.0,margin: EdgeInsets.only(top: MediaQuery.of(context).padding.top),
              child: Stack(children: [
                ...
                Positioned(right:11.0, top:10.0,child: Row(children: [
                  ...
                  GestureDetector(child:Image.asset("image/icon_player_cc.png",width: 24.0,height: 24.0),onTap: (){
                    showModalBottomSheet(
                        builder: (BuildContext context1) {
                          return Container(height:MediaQuery.of(context).size.height-270,width:MediaQuery.of(context).size.width*2,color:Color(0xff111218),child:ListView(controller:_htVarSubtScrollController,scrollDirection:Axis.horizontal,children:[1,2].map((index)=>index==1?Container(width:MediaQuery.of(context).size.width,child: Column(children: [
                            Container(height: 51.0, alignment:Alignment.center,color:Color(0xff191B21),child:
                            Row(children: [
                              Container(width: 16.0),
                              Image.asset("image/icon_play_subtitle_exit.png",width: 16.0,height: 16.0),
                              Expanded(child:Container(alignment:Alignment.center,child:Text("Subtitles",style: TextStyle(color: Color(0xffECECEC),fontSize: 18.0,fontWeight: FontWeight.w600)))),
                              Container(width: 32.0),
                            ])),
                            Container(margin: EdgeInsets.only(top: 20.0,left: 16.0),child: Row(children: [
                              Image.asset("image/icon_play_subtitle_off.png",width: 26.0, height:26.0),
                              Container(width: 10.0),
                              Text("Turn on Subtitles",style: TextStyle(color: Color(0xffECECEC),fontSize: 16.0)),
                            ])),
                            GestureDetector(child:Container(margin: EdgeInsets.only(top: 24.0,left: 16.0),child: Row(children: [
                              Image.asset("image/icon_play_languages.png",width: 26.0, height:26.0),
                              Container(width: 10.0),
                              Text("Switch Languages",style: TextStyle(color: Color(0xffECECEC),fontSize: 16.0)),
                            ])),onTap: (){
                              _htVarSubtScrollController.animateTo(MediaQuery.of(context).size.width, duration: Duration(milliseconds: 500), curve: Curves.ease);
                            }),
                          ])):Container(width:MediaQuery.of(context).size.width,child:Column(children: [
                            Container(height: 51.0, alignment:Alignment.center,color:Color(0xff191B21),child:
                            Row(children: [
                              Container(width: 16.0),
                              Image.asset("image/icon_play_language_back.png",width: 16.0,height: 16.0),
                              Container(width: 10.0),
                              Text("Switch Language",style: TextStyle(color: Color(0xffECECEC),fontSize: 18.0,fontWeight: FontWeight.w600)),
                              Container(width: 32.0),
                            ])),
                            Expanded(child:ListView(
                              scrollDirection: Axis.vertical,
                              children: [1,2,3,4,5].map((index) => Container(padding:EdgeInsets.fromLTRB(16, 0, 16, 0),height: 48.0,decoration:BoxDecoration(color: Color(0xff111218)),child: Row(mainAxisAlignment:MainAxisAlignment.start,children: [
                                Image.asset("image/icon_play_language_h.png",width: 16.0,height: 16.0),
                                Container(width: 8.0),
                                Text("Chinese-Chinese Simplefied",style: TextStyle(color: Colors.white,fontSize: 14.0),maxLines: 1,),
                              ]))).toList(),
                            ))
                          ]))).toList()));
                        },
                  ...
                  Container(width: 10.0),
                  GestureDetector(child:Image.asset("image/icon_player_tv.png",width: 24.0,height: 24.0),onTap: (){
          ...
          Row(children: [
            GestureDetector(child:Container(margin: EdgeInsets.only(left: 10.0),width:95.0,height: 28.0,decoration:BoxDecoration(color: Color(0xff23252A),borderRadius: BorderRadius.circular(5.0)),child: Row(mainAxisAlignment:MainAxisAlignment.center,children: [
              Text("Season 1",style: TextStyle(color:Colors.white,fontSize: 14.0)),
              Container(width: 6.0),
              Image.asset("image/icon_play_episode_down.png",width: 10.0,height:8.0)
            ])),onTap:(){
              showQudsPopupMenu(context: context,backgroundColor:Color(0xff23252A),startOffset:Offset(0, 650.0-_htVarScrollController.offset*1.5),items:[
                QudsPopupMenuItem(
                    title: Text('episode 1',style: TextStyle(color:Color(0xffECECEC),fontSize: 14.0),),
                    onPressed: () {
                 }),
                QudsPopupMenuItem(
                    title: Text('episode 2',style: TextStyle(color:Color(0xffECECEC),fontSize: 14.0)),
                    onPressed: () {
                    }),
                QudsPopupMenuItem(
                    title: Text('episode 3',style: TextStyle(color:Color(0xffECECEC),fontSize: 14.0)),
                    onPressed: () {
                    }),
              ]);
            }),
            ...
            GestureDetector(child:Row(children: [
              Text("All Episodes",style: TextStyle(color: Color(0xff999999),fontSize: 14.0)),
              Container(width: 4.0),
              Image.asset("image/icon_play_drama_arrowr.png",width:16.0,height: 16.0),]),onTap: (){
                showModalBottomSheet(
                  builder: (BuildContext context1) {
                  return Container(height:MediaQuery.of(context).size.height-270,color:Color(0xff111218),child:Column(children: [
                    Container(height: 20.0),
                    Row(children: [
                      Container(width: 10.0),
                      Text("Episodes",style: TextStyle(color: Color(0xffECECEC),fontSize: 16.0,fontWeight: FontWeight.w500)),
                      Spacer(),
                      Image.asset("image/icon_play_eps_exit.png",width:20.0,height: 20.0),
                      Container(width: 10.0,)
                    ]),
                    Container(margin:EdgeInsets.fromLTRB(10.0, 20.0, 10.0, 9.0), height:30.0,child: ListView(
                      scrollDirection: Axis.horizontal,
                      children: [1,2,3,4,5].map((index) => Container(padding:EdgeInsets.fromLTRB(12, 8, 12, 8),margin: EdgeInsets.only(right:10.0),width: 74.0,height: 30.0,decoration:BoxDecoration(color: Color(0xff23252A),borderRadius: BorderRadius.circular(5.0)),child: Column(crossAxisAlignment:CrossAxisAlignment.start,children: [
                        Text("Season 1",style: TextStyle(color: Colors.white,fontSize: 12.0),maxLines: 1),
                      ]))).toList(),
                    )),
                    Container(height: 1,color: Color(0xff3F3F5C)),
                    Expanded(child:ListView(
                      scrollDirection: Axis.vertical,
                      children: [1,2,3,4,5].map((index) => Container(padding:EdgeInsets.fromLTRB(16, 10, 16, 10),margin: EdgeInsets.only(top:10.0),height: 60.0,decoration:BoxDecoration(color: Color(0xff23252A)),child: Column(crossAxisAlignment:CrossAxisAlignment.start,children: [
                        Text("Season 1",style: TextStyle(color: Colors.white,fontSize: 16.0),maxLines: 1),
                        Container(height: 4.0),
                        Text("when van helsing’s mysterious invention myster ious...",style: TextStyle(color: Colors.white,fontSize: 14.0),maxLines: 1,),
                      ]))).toList(),
                    ))
                  ]));
                  },
          ...
          Container(margin: EdgeInsets.symmetric(horizontal: 10.0),height:66.0,child: ListView(
            scrollDirection: Axis.horizontal,
            children: [1,2,3,4,5].map((index) => Container(padding:EdgeInsets.fromLTRB(10, 10, 10, 0),margin: EdgeInsets.only(right:10.0),width: 140.0,height: 66.0,decoration:BoxDecoration(color: Color(0xff23252A),borderRadius: BorderRadius.circular(4.0)),child: Column(crossAxisAlignment:CrossAxisAlignment.start,children: [
              Text("EP 1",style: TextStyle(color:Color(0xff999999),fontSize: 10.0)),
              Container(height: 4.0),
              Text("Ryomen Sukuna\naisfhioa aios ryomen sukuna",style: TextStyle(color: Colors.white,fontSize: 12.0),maxLines: 2,),
            ]))).toList(),
          )),
  ...
  void htMethodshowScreenSheet(BuildContext context){
    showModalBottomSheet(context:context, backgroundColor:Colors.transparent, builder: (context1){
      return Container(height:331.0,decoration: BoxDecoration(color: Color(0xff292A2F),borderRadius: BorderRadius.only(topLeft:Radius.circular(24.0),topRight: Radius.circular(24.0))),child: Column(children: [
        Container(height: 53.7),
        Image.asset("image/icon_play_screen_logo.png",width: 78.0,height: 78.0),
        Container(height: 28.7),
        Text("Install Castly APP to cast Overflow\n(Uncensored)",style: TextStyle(color:Color(0xffFFD770),fontSize: 18.0,fontWeight: FontWeight.w600)),
        Container(height:18.2),
        Text("Jumping to Castly ...",style: TextStyle(color: Color(0xff999999),fontSize: 14.0)),
      ]));
    });
  }
}