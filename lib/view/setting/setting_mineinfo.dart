...
class HTClassSettingInfoPage extends StatefulWidget {
  const HTClassSettingInfoPage({Key? key, required this.title}) : super(key: key);
  final String title;
  @override
    ...
    return Container(
      child: GestureDetector(
          child: Row(children: [
            ...
            const Spacer(),
            Image.network(ImageURL.url_289,
...
///第三行
 Widget historyWidget(){
    return Row(
        children: [
          Container(width: 10.0),
          Image.network(ImageURL.url_343,
      ...
      const Spacer(),
      GestureDetector(
          child: Image.network(ImageURL.url_289,
              width: 24.0, height: 24.0),
          onTap: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) {
...
Widget watchListWidget(){
    return  GestureDetector(
        child: Row(children: [
          Image.network(ImageURL.url_344,
              width: 16.0, height: 16.0),
          Container(width: 5.0),
...
Widget shareWidget(){
  return GestureDetector(
      child: Row(children: [
        Image.network(ImageURL.url_345,
            width: 16.0, height: 16.0),
        Container(width: 5.0),
        const Text("Feedback",
            style: TextStyle(
...
///feedback
  Widget feedbackWidget(){
    return GestureDetector(
        child: Row(children: [
          Image.network(ImageURL.url_346,
              width: 16.0, height: 16.0),
          Container(width: 5.0),
          const Text("Feedback",
              style: TextStyle(
