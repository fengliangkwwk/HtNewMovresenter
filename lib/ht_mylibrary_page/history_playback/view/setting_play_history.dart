...
class HTClassPresHistoryPage extends StatefulWidget {
  const HTClassPresHistoryPage({Key? key, required this.title})
      : super(key: key);
  ...
  @override
  State<HTClassPresHistoryPage> createState() => _HTClassPresHistoryPageState();
}

class _HTClassPresHistoryPageState extends State<HTClassPresHistoryPage> {
  @override
  void initState() {
    super.initState();
  }
                      ...
                      child: Column(children: [
                        ...
                        Container(
                            ...
                            child: LinearProgressIndicator(
                              ...
                              minHeight: 2,
                              valueColor:
                                  AlwaysStoppedAnimation(Color(0xff3CDEF4)),
                              ...
                              Offstage(
                                  ...
                                  child: RoundCheckBox(
                                      ...
                                      uncheckedWidget: Image.asset(
                                          "image/icon_history_check_n.png"),
                                      checkedWidget: Image.asset(
                                          "image/icon_history_check_h.png"),
