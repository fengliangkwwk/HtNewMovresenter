...
class KTClassUIUtils{
  ...
  static Future<Map<String, dynamic>> htMethodPutRequestCommonParams(Map<String,dynamic> htVarParam) async {
    try {
...
//通知栏回调里的deviceToken
  ...
  static setDeviceResolution(BuildContext context){
    defRes = MediaQuery.of(context).size.width.toString()+"x"+MediaQuery.of(context).size.height.toString();
  }
}
